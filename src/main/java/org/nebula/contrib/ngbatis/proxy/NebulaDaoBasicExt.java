...
public class NebulaDaoBasicExt {
    ...
    public static String vertexName(Class<?> entityType) {
        ...
        return tableAnno != null ? tableAnno.name()
    ...
    public static Class<?>[] entityTypeAndIdType(Class<?> currentType) {
        ...
        for (Type genericInterface : genericInterfaces) {
            if (isCurrentTypeOrParentType(genericInterface.getClass(),
     ...
     * {@link MapperProxy#invoke(
     *     org.nebula.contrib.ngbatis.models.MethodModel, java.lang.Object...)
     * MapperProxy.proxy}
     *
     ...
     */
    public static Object proxy(Class<?> currentType, Class<?> returnType,
            String nGQL, Class<?>[] argTypes, Object... args) {
        Method method = null;
        try {
