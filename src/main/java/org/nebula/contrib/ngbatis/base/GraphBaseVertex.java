...
public abstract class GraphBaseVertex extends GraphBase {
	 ...
	 * @param <I> 起始点id类型
	 */
	public <T extends GraphBaseVertex,I> NgPath<I> queryShortestPath(Integer maxHop,Direction direction,T v2){
		String tagName = getEntityTypeName();
		Map<String, Object> entityProperties = getEntityProperties();
	 ...
	 * @param <I> 起始点id类型
	 */
	public <T extends GraphBaseVertex,I> List<NgPath<I>> queryAllShortestPaths(Integer maxHop,Direction direction,T v2){
		String tagName = getEntityTypeName();
		Map<String, Object> entityProperties = getEntityProperties();
	 ...
	 * @param <I> 起始点id类型
	 */
	public <I> List<NgPath<I>> queryFixedLengthPath(Integer maxHop,Direction direction,Class<?>... edgeClass){
		String tagName = getEntityTypeName();
		Map<String, Object> entityProperties = getEntityProperties();
	 ...
	 * @param <I> 起始点id类型
	 */
	public <I> List<NgPath<I>> queryVariableLengthPath(Integer minHop,Integer maxHop,Direction direction,Class<?> edgeClass){
		String tagName = getEntityTypeName();
		Map<String, Object> entityProperties = getEntityProperties();
		String gql = matchVariableLengthPath(tagName,entityProperties,minHop,maxHop,direction,edgeClass);
		log.info("nGQL:{}",gql);
		try {
			ResultSet resultSet = executeGQL(gql);
			return (List<NgPath<I>>) handleResult(resultSet, List.class,NgPath.class);
