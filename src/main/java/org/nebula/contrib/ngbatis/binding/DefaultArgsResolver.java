...
public class DefaultArgsResolver implements ArgsResolver {
    @Override
    public Map<String, Object> resolve(MethodModel methodModel,
            Object... args) {
        ...
        Annotation[][] parameterAnnotations = methodModel
                .getParameterAnnotations();
        for (int i = 0; i < len; i++) {
            Annotation[] annotationArgIndex = parameterAnnotations[i];
            int annoLen = annotationArgIndex == null ? 0
                    : annotationArgIndex.length;
    ...
    public static Map<Class<?>, Setter> LEAF_TYPE_AND_SETTER = new HashMap<Class<?>, Setter>() {
        {
            ...
            put(String.class,
                    (Setter<String>) (param) -> Value.sVal(param.getBytes()));
    ...
    public static Map<Class<?>, Setter> COMPLEX_TYPE_AND_SETTER = new LinkedHashMap<Class<?>, Setter>() {
        {
            ...
            put(Date.class, (Setter<Date>) (date) -> {
                Calendar calendar = new Calendar.Builder().setInstant(date)
                        .build();
                return Value.dtVal(new DateTime(
                        ...
                        new Short(String
                                .valueOf(calendar.get(Calendar.MILLISECOND)))));
            });
            ...
            put(Object.class, (Setter<Object>) (obj) -> {
                ...
                for (Field declaredField : declaredFields) {
                    pojoFields.put(declaredField.getName(), toNebulaValueType(
    ...
    public Object customToJSON(Object o) {
        try {
            ...
            String text = JSON.toJSONString(o, parserConfig,
