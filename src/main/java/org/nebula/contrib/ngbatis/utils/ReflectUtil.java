...
public class ReflectUtil {
    ...
    public static List<Class<?>> NUMBER_TYPES = Arrays.asList(int.class,
            Integer.class, long.class, Long.class, float.class, Float.class,
            double.class, Double.class, byte.class, Byte.class, short.class,
            Short.class);
    ...
    static {
        CLASSES = Arrays.asList(String.class, Character.class, char.class,
                ...
                Byte.class, byte.class, Short.class, short.class, Integer.class,
    ...
    public static boolean isCurrentTypeOrParentType(Class<?> paramType,
            Class<?> pType) {
        if (paramType == pType)
            return true;
    ...
    public static Field getPkField(Field[] fields, Class<?> type,
        ...
        if (canNotNull && pkField == null) {
            throw new ParseException(String
                    .format("%s 必须有一个属性用 @Id 注解。（javax.persistence.Id）", type));
        }
        return pkField;
    }
